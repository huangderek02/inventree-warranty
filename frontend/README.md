# Warranty- Frontend Code

This directory contains the frontend code for the Warranty plugin.
...
This will compile the frontend into the `../warranty/static` directory (ready for distribution).
