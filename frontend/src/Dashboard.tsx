 ...
 */
function WarrantyDashboardItem({
  context
}: {
  ...
  const pluginName: string = 'Warranty';
...
//  component
export function renderWarrantyDashboardItem(context: InvenTreePluginContext) {
  checkPluginVersion(context);
  return <WarrantyDashboardItem context={context} />;
}
